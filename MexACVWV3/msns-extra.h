;****************************************************************************
;* msns-extra.h MexACVW3 version, include file for msns-extra.asm MexACVW3 
;* version 
...
secl:           ds	1  ; low seconds - from 0 to 255, then rollover     ;* 0
squirt:         ds  1  ; Event variable bit field for Injector Firing   ;* 1
...
engine:         ds  1  ; Variable bit-field to hold engine current status  ;* 2
...
baro:           ds	1	; Barometer ADC Raw Reading - KPa (0 - 255)                  ;* 3
map:            ds	1	; Manifold Absolute Pressure ADC Raw Reading - KPa (0 - 255) ;* 4
mat:            ds	1	; Manifold Air Temp ADC Raw Reading - counts (0 - 255)       ;* 5
clt:            ds	1	; Coolant Temperature ADC Raw Reading - counts (0 - 255)     ;* 6
tps:            ds	1	; Throttle Position Sensor ADC Raw Reading - counts, represents 0 - 5 volts  ;* 7
batt:           ds	1	; Battery Voltage ADC Raw Reading - counts                   ;* 8
ego:            ds  1   ; Exhaust Gas Oxygen ADC Raw Reading - counts                ;* 9
egocorr:        ds  1   ; Oxygen Sensor Correction                                   ;* 10
aircor:         ds  1   ; Air Density Correction lookup - percent                    ;* 11
warmcor:        ds  1   ; Total Warmup Correction - percent                          ;* 12
rpm:            ds  1   ; Computed engine RPM - rpm/100                              ;* 13
pw1:            ds  1   ; injector squirt time in 1/10 millesec (0 to 25.5 millisec) - applied  ;* 14
tpsaccel:       ds  1   ; Acceleration enrichment - percent                          ;* 15
barocor:        ds  1   ; Barometer Lookup Correction - percent                      ;* 16
gammae:         ds  1   ; Total Gamma Enrichments - percent                          ;* 17
vecurr:         ds  1   ; Current VE value from lookup table - percent               ;* 18
pw2:            ds  1                                                                ;* 19
vecurr2:        ds  1                                                                ;* 20
idleDC:         ds  1                                                                ;* 21

;********************************************************************************************
;* This marks the end of output channels ordered list sent by the "A" commnd, 22 in total
;********************************************************************************************

ctimeCommH:     ds  1   ; Cycle time H for communication                             ;* 22
ctimeCommL:     ds  1   ; Cycle time L for communication                             ;* 23
SparkAngle:     ds  1   ; Spark angle (256 = 90 deg)                                 ;* 24
afrTarget:      ds  1   ; AFR Target temp variable                                   ;* 25
o2_fpadc:       ds  1   ; Second O2 sensor or Fuel Pressure                          ;* 26
egtadc:         ds  1   ; EGT Temperature                                            ;* 27
CltIatAngle:    ds  1   ; Coolant Iat Angle                                          ;* 28
KnockAngle:     ds  1   ; Knock Angle                                                ;* 29
egoCorr2:       ds  1   ; Second O2 sensor Ego Correction                            ;* 30

;********************************************************************************************

;* This marks the end of output channels ordered list sent by the "R" commnd.
;* The following channels are also sent, 39 in total.
;* porta   ;* 31 (Declared in GP32.equ)
;* portb   ;* 32 (Declared in GP32.equ)
;* portc   ;* 33 (Declared in GP32.equ)
;* portd   ;* 34 (Declared in GP32.equ)
;* stackL  ;* 35 (Stack pointer)
;* TPSlast ;* 36
;* itimeX  ;* 37
;* bcDC    ;* 38
...
; Bit fields for "SparkBits" variable
...
; Bit fields for "RevLimBits" variable                                      
...
; Bit fields for "personality" variable
...
; Bit fields for "outputpins" variable
...
; Bit fields for "feature1" variable
...
; Bit fields for "feature2" variable
BoostControl    equ 0
ShiftLight      equ 1
LaunchControl   equ 2
; spare         equ 3
...
; Bit fields for "feature7" variable
...
; Bit fields for "EnhancedBits" variable
...
; Bit fields for "EnhancedBits2" variable
...
; Bit fields for "coilsel" variable
...
; Bit fields for "EnhancedBits4" variable
...
; Bit fields for "EnhancedBits5" variable
...
; Bit fields for "EnhancedBits6" variable
...
; Bit field for "CONFIG11_r" variable 
;  Bit 0-1 = MAP Type
;            00 = MPX4115AP
;            01 = MPX4250AP
;            10 = MPXH6300A
...
; Bit field for "CONFIG12_r" variable
...
; Bit field for "CONFIG13_r" variable
