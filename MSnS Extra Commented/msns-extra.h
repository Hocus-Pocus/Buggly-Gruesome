...
secl:           ds	1	; low seconds - from 0 to 255, then rollover                    ;* Tuner Studio secl 0
squirt:         ds  1   ; Event variable bit field for Injector Firing                  ;* Tuner Studio squirt 1
...
engine:         ds  1   ; Variable bit-field to hold engine current status              ;* Tuner Studio engine 2
...
baro:           ds	1	; Barometer ADC Raw Reading - KPa (0 - 255)                                 ;* Tuner Studio baroADC 3
map:            ds	1	; Manifold Absolute Pressure ADC Raw Reading - KPa (0 - 255)                ;* Tuner Studio mapADC 4
mat:            ds	1	; Manifold Air Temp ADC Raw Reading - counts (0 - 255)                      ;* Tuner Studio matADC 5
clt:            ds	1	; Coolant Temperature ADC Raw Reading - counts (0 - 255)                    ;* Tuner Studio cltADC 6
tps:            ds	1	; Throttle Position Sensor ADC Raw Reading - counts, represents 0 - 5 volts ;* Tuner Studio tpsADC 7
batt:           ds	1	; Battery Voltage ADC Raw Reading - counts                                  ;* Tuner Studio batADC 8
ego:            ds  1   ; Exhaust Gas Oxygen ADC Raw Reading - counts                               ;* Tuner Studio egoADC 9
egocorr:        ds  1   ; Oxygen Sensor Correction                                                  ;* Tuner Studio egoCorrection 10
aircor:         ds  1   ; Air Density Correction lookup - percent                                   ;* Tuner Studio airCorrection 11
warmcor:        ds  1   ; Total Warmup Correction - percent                                         ;* Tuner Studio warmupEnrich 12
rpm:            ds  1   ; Computed engine RPM - rpm/100                                             ;* Tuner Studio RPM100 13
pw1:            ds  1   ; injector squirt time in 1/10 millesec (0 to 25.5 millisec) - applied      ;* Tuner Studio pulseWidth1 14
tpsaccel:       ds  1   ; Acceleration enrichment - percent                                         ;* Tuner Studio accelEnrich 15
barocor:        ds  1   ; Barometer Lookup Correction - percent                                     ;* Tuner Studio baroCorrection 16
gammae:         ds  1   ; Total Gamma Enrichments - percent                                         ;* Tuner Studio gammaEnrich 17
vecurr:         ds  1   ; Current VE value from lookup table - percent                              ;* Tuner Studio veCurr1 18
pw2:            ds  1   ;                                     ;* NOT USED                           ;* Tuner Studio pulseWidth2 19
vecurr2:        ds  1   ;                                     ;* NOT USED                           ;* Tuner Studio veCurr2 20
idleDC:         ds  1   ;                                     ;* IDLE DUTY CYCLE                    ;* Tuner Studio idleDC 21
ctimeCommH:     ds  1   ; Cycle time H for communication                                            ;* Tuner Studio iTime 22
ctimeCommL:     ds  1   ; Cycle time L for communication                                            ;* Tuner Studio iTime 23
SparkAngle:     ds  1   ; Spark angle (256 = 90 deg)                                                ;* Tuner Studio advance 24
afrTarget:      ds  1   ; AFR Target temporary variable                                             ;* Tuner Studio afrtarget 25
o2_fpadc:       ds  1   ; Second O2 sensor or Fuel Pressure	  ;* NOT USED                           ;* Tuner Studio fuelADC 26
egtadc:         ds  1   ; EGT Temperature                     ;* NOT USED                           ;* Tuner Studio egtADC 27
CltIatAngle:    ds  1   ; Coolant Iat Angle                   ;* NOT USED                           ;* Tuner Studio CltIatAngle 28
KnockAngle:     ds  1   ; Knock Angle                         ;* NOT USED                           ;* Tuner Studio KnockAngle 29
egoCorr2:       ds  1   ; Second O2 sensor Ego Correction     ;* NOT USED                           ;* Tuner Studio egoCorrection2 30
...
RevLimBits      ds  1   ; Rev limiter status bits                   ;* NOT USED
